...
Gsurv<-function(
    ...
    ############################################################################
    Greg.SuperLearner(covariates,follow.up.time,pred_event.list,visit.times,tvals,truncation.index,id.var,time.var,event.var,Q.formula,Q.SuperLearner.control,obs.weight.var)
}
